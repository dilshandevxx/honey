    ...
    <section className="relative min-h-[100svh] w-full flex flex-col items-center justify-center overflow-hidden pt-28 pb-12 md:pt-32 md:pb-16">
      ...
      <div className="z-10 flex flex-col items-center text-center space-y-6 sm:space-y-8 md:space-y-10 w-full px-4">
        ...
        <motion.div
           ...
           className="relative w-36 h-36 sm:w-40 sm:h-40 md:w-40 md:h-40 xl:w-48 xl:h-48 flex items-center justify-center"
        >
            ...
            <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-24 md:h-24 xl:w-28 xl:h-28 bg-gradient-to-br from-honey-dark to-honey-black border border-honey-blue/50 rounded-full shadow-[0_0_30px_rgba(0,255,255,0.3)] flex items-center justify-center">
                <div className="w-2 h-2 md:w-2 md:h-2 bg-honey-blue rounded-full shadow-[0_0_20px_#00FFFF]" />
            </div>
        </motion.div>
        ...
        <div className="relative w-full">
            ...
            className="text-[11vw] sm:text-[5.5rem] md:text-[6.5rem] lg:text-[7.5rem] xl:text-[8.5rem] leading-[0.85] font-bold tracking-tighter text-white"
            >
            ENGINEERING
            <br />
            INTELLIGENCE
